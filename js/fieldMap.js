...
const TEMPLATES = [
  ...
  // (I слева) переставляются в buildLetterheadValues (app.js).
  {
    ...
    fields: [
      ...
      { key: 'heat_load_heating', label: 'Тепловая нагрузка отопления',     group: 'manual', shapeIds: [], unit: null, notes: 'В спецификации отсутствует — введите вручную' },
      { key: 'temp_graph',        label: 'Температурный график сетевой воды, °C', group: 'manual', shapeIds: [], unit: '°C', notes: 'В спецификации отсутствует — введите вручную, например 130/70' },
