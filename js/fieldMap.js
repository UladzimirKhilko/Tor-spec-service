...
const TEMPLATES = [
  {
    ...
    fields: [
      ...
      { key: 'port_legend_note',
        label: 'Назначение патрубков (список справа от картинки "Общий вид")',
        group: 'manual', shapeIds: [], unit: null, multiline: true,
        notes: 'Текст подставляется автоматически из загруженного PDF-бланка (список Т1/Т2/В1/Т3 и т.п.) — проверьте и поправьте при необходимости. Сама картинка "Общий вид" теперь вырезается без этого текста — он печатается отдельным полем справа от картинки' },
    ],
  },
  ...
  // (I слева) переставляются в buildLetterheadValues (app.js).
  {
    ...
    fields: [
      ...
      { key: 'port_legend_note',
        label: 'Назначение патрубков (список справа от картинки "Общий вид")',
        group: 'manual', shapeIds: [], unit: null, multiline: true,
        notes: 'Текст подставляется автоматически из загруженного PDF-бланка (список Т1/Т2/В1/Т3/Т22/Т4) — проверьте и поправьте при необходимости. Сама картинка "Общий вид" теперь вырезается без этого текста — он печатается отдельным полем справа от картинки' },
    ],
  },
];
